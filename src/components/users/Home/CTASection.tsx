  ...
  return (
    <section className="py-16 md:py-24 bg-brand-primary relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-primary-foreground mb-6 animate-fade-in-up">
          Ready to Get Legal Help?
        </h2>
        <p className="text-lg md:text-xl text-primary-foreground/80 mb-10 max-w-2xl mx-auto animate-fade-in-up animation-delay-100">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-200">
          ...
          <Button
            variant="outline"
            size="lg"
            className="bg-transparent border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-brand-primary font-semibold text-lg px-8 group"
          >
        ...
        <p className="mt-8 text-sm text-primary-foreground/60 animate-fade-in-up animation-delay-300">
