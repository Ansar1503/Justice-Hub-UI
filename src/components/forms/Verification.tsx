...
function LawyerVerificationForm({
  ...
  const { mutateAsync } = useLawyerVerification();
  ...
  return (
    <form
      className="space-y-8 max-w-4xl mx-auto p-6 overflow-visible"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                {errors.barcouncilid && (
                  <p className="text-red-500 text-sm">{errors.barcouncilid}</p>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="enrollment_certificate">
                  Enrollment Certificate <span className="text-red-500">*</span>
                </Label>
                <div className="flex items-center gap-2">
                  <Input
...
function LawyerVerificationFormModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setVerificationModalOpen}>
      <DialogContent className="max-w-4xl p-0 border-none bg-transparent shadow-none max-h-[90vh] overflow-y-auto scrollbar-hide">
