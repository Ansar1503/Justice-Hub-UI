function Footer() {
  return (
    <footer
      ...
      bg-brandPrimary text-white dark:bg-[#1A1C2B] dark:text-[#E0E0E0]"
    >
      <div className="flex flex-col md:flex-row justify-stretch items-start md:items-center gap-20">
        ...
        <aside className="flex flex-col items-center md:items-start ">
          ...
          <p className="text-center md:text-left mt-2">
            Justice Hub
            <br />
            Providing legal solutions since 2025
          </p>
        </aside>

        <div className="flex flex-wrap justify-center md:justify-end gap-24">
          <nav className="flex flex-col text-center md:text-left">
            <h6 className="font-semibold">Services</h6>
            <a className="hover:underline cursor-pointer">Consultations</a>
            <a className="hover:underline cursor-pointer">Legal Advice</a>
            <a className="hover:underline cursor-pointer">Document Review</a>
            <a className="hover:underline cursor-pointer">Case Support</a>
          </nav>
