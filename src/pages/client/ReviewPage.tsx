...
export default function ReviewPage() {
  ...
  function handleShowFeedbackModal(
    lawyerId: string,
    lawyerName: string,
    sessionID: string
  ) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFF2F2] dark:bg-black">
      ...
      <FeedbackModal
        ...
        lawyerId={feedbackModalData.lawyer_id}
        lawyerName={feedbackModalData.lawyer_name}
        onClose={() => setShowFeedbackModal(false)}
        sessionId={feedbackModalData.session_id}
      />
    </div>
  );
}
